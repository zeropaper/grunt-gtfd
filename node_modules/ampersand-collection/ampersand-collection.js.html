...
<body>
  ...
  <div class="container content">
    <div class="row"><div class="documentation"></div><div class="code"><pre><code class="js"><span class="hljs-keyword">var</span> BackboneEvents = <span class="hljs-built_in">require</span>(<span class="hljs-string">'backbone-events-standalone'</span>);
...
extend(Collection.prototype, BackboneEvents, {
...
</code></pre></div></div><div class="row"><div class="documentation"><p> overridable parse method</p>
</div><div class="code"><pre><code class="js">    parse: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(res, options)</span> </span>{
        <span class="hljs-keyword">return</span> res;
    },
</code></pre></div></div><div class="row"><div class="documentation"><p> overridable serialize method</p>
</div><div class="code"><pre><code class="js">    serialize: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">()</span> </span>{
        ...
        <span class="hljs-keyword">var</span> targetProto = <span class="hljs-keyword">this</span>.model &amp;&amp; <span class="hljs-keyword">this</span>.model.prototype || <span class="hljs-built_in">Object</span>.prototype;
</code></pre></div></div><div class="row"><div class="documentation"><p> Turn bare objects into model references, and prevent invalid models<br> from being added.</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>, length = models.length; i &lt; length; i++) {
            attrs = models[i] || {};
            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.isModel(attrs)) {
...
</code></pre></div></div><div class="row"><div class="documentation"><p> If a duplicate is found, prevent it from being added and<br> optionally merge it into the existing model.</p>
</div><div class="code"><pre><code class="js">            <span class="hljs-keyword">if</span> (existing = <span class="hljs-keyword">this</span>.get(id)) {
                ...
                <span class="hljs-keyword">if</span> (merge) {
                    ...
                    <span class="hljs-keyword">if</span> (options.parse) attrs = existing.parse(attrs, options);</code></pre></div></div><div class="row"><div class="documentation"><p> if this is model</p>
</div><div class="code"><pre><code class="js">                    <span class="hljs-keyword">if</span> (existing.set) {
                        existing.set(attrs, options);
                        <span class="hljs-keyword">if</span> (sortable &amp;&amp; !sort &amp;&amp; existing.hasChanged(sortAttr)) sort = <span class="hljs-literal">true</span>;
                    } <span class="hljs-keyword">else</span> {</code></pre></div></div><div class="row"><div class="documentation"><p> if not just update the properties</p>
</div><div class="code"><pre><code class="js">                        extend(existing, attrs);
                    }
                }
                models[i] = existing;
</code></pre></div></div><div class="row"><div class="documentation"><p> If this is a new, valid model, push it to the <code>toAdd</code> list.</p>
</div><div class="code"><pre><code class="js">            } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (add) {
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Do not add multiple models with the same <code>id</code>.</p>
</div><div class="code"><pre><code class="js">            model = existing || model;
            <span class="hljs-keyword">if</span> (!model) <span class="hljs-keyword">continue</span>;
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Remove nonexistent models if appropriate.</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">if</span> (remove) {
...
</code></pre></div></div><div class="row"><div class="documentation"><p> See if sorting is needed, update <code>length</code> and splice in new models.</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">if</span> (toAdd.length || (order &amp;&amp; order.length)) {
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Silently sort the collection if appropriate.</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">if</span> (sort) <span class="hljs-keyword">this</span>.sort({silent: <span class="hljs-literal">true</span>});
</code></pre></div></div><div class="row"><div class="documentation"><p> Unless silenced, it’s time to fire all appropriate add/sort events.</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">if</span> (!options.silent) {
            <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>, length = toAdd.length; i &lt; length; i++) {
                model = toAdd[i];
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Return the added (or merged) model (or models).</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">return</span> singular ? models[<span class="hljs-number">0</span>] : models;
    },
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Get the model at the given index.</p>
</div><div class="code"><pre><code class="js">    at: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(index)</span> </span>{
...
</code></pre></div></div><div class="row"><div class="documentation"><p> When you have more items than you want to add or remove individually,<br> you can reset the entire set with a new list of models, without firing<br> any granular <code>add</code> or <code>remove</code> events. Fires <code>reset</code> when finished.<br> Useful for bulk operations and optimizations.</p>
</div><div class="code"><pre><code class="js">    reset: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(models, options)</span> </span>{
        options || (options = {});
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Private method to reset all internal state. Called when the collection<br> is first initialized or reset.</p>
</div><div class="code"><pre><code class="js">    _reset: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">()</span> </span>{
    ...
    _prepareModel: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(attrs, options)</span> </span>{</code></pre></div></div><div class="row"><div class="documentation"><p> if we haven’t defined a constructor, skip this</p>
</div><div class="code"><pre><code class="js">        <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.model) <span class="hljs-keyword">return</span> attrs;
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Internal method to create a model’s ties to a collection.</p>
</div><div class="code"><pre><code class="js">    _addReference: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(model, options)</span> </span>{
...
</code></pre></div></div><div class="row"><div class="documentation"><p> Internal method to sever a model’s ties to a collection.</p>
</div><div class="code"><pre><code class="js">    _removeReference: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(model, options)</span> </span>{
...
</code></pre></div></div><div class="row"><div class="documentation"><p> alias each/forEach for maximum compatibility</p>
</div><div class="code"><pre><code class="js">Collection.prototype.each = Collection.prototype.forEach;
