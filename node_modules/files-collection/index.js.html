...
<span class="hljs-keyword">var</span> Model = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ampersand-model'</span>);
      ...
      <div class="row">
        <div class="col-md-12 col-lg-6"><h5 id="internal-extname">internal extname</h5>
</div>
        <div class="col-md-12 col-lg-6"><pre><code class="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">extname</span><span class="hljs-params">(str)</span> </span>{
  <span class="hljs-keyword">return</span> path.extname(path.basename(str, <span class="hljs-string">'.html'</span>));
      ...
      <div class="row">
        <div class="col-md-12 col-lg-6"><h5 id="internal-toproject">internal toProject</h5>
</div>
        <div class="col-md-12 col-lg-6"><pre><code class="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">toProject</span><span class="hljs-params">(str)</span> </span>{
  <span class="hljs-keyword">return</span> str.split(<span class="hljs-string">'/'</span>).length &gt; <span class="hljs-number">1</span> ? path.dirname(str).replace(<span class="hljs-regexp">/([^\/]+)/gi</span>, <span class="hljs-string">'..'</span>) : <span class="hljs-string">''</span>;
}

<span class="hljs-keyword">var</span> FileModel;

<span class="hljs-keyword">var</span> DirectoryCollection = Collection.extend({
...
FileModel = Model.extend({
  ...
  derived: {
    ...
    toProjectDir: {
      deps: [<span class="hljs-string">'filepath'</span>],
      fn: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">()</span> </span>{
        <span class="hljs-keyword">return</span> toProject(<span class="hljs-keyword">this</span>.filepath);
      }
    },
    ...
    fileurl: {
      ...
      cache: <span class="hljs-literal">false</span>,
      fn: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">()</span> </span>{
        <span class="hljs-keyword">return</span> path.relative(path.dirname(<span class="hljs-keyword">this</span>.collection.active), <span class="hljs-keyword">this</span>.filepath);
      }
    },
  ...
  resolve: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(obj)</span> </span>{
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">typeof</span> destination === <span class="hljs-string">'string'</span> ?
            path.resolve(<span class="hljs-keyword">this</span>.dirname, destination) :
  ...
  relative: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(obj)</span> </span>{
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">typeof</span> destination === <span class="hljs-string">'string'</span> ?
            path.relative(<span class="hljs-keyword">this</span>.dirname, destination) :
            <span class="hljs-keyword">this</span>.toProjectDir;
  },
...
<span class="hljs-keyword">var</span> FilesCollection = <span class="hljs-built_in">module</span>.exports = Collection.extend({
  ...
  setActive: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-params">(active)</span> </span>{
    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">arguments</span>.length &amp;&amp; active !== <span class="hljs-keyword">this</span>.active) {
...
FilesCollection.Directory = DirectoryCollection;
  ...
  <script>
  var config = {"files":["Gruntfile.js","README.md","lib/blocks-collection.js","lib/index.js","lib/rendering-utils.js","node_modules/ampersand-collection/ampersand-collection.js","node_modules/ampersand-model/ampersand-model.js","node_modules/files-collection/index.js","resources/themes/default/assets/scripts/scripts.src.js","resources/themes/default/assets/scripts/search.src.js","resources/themes/default/assets/styles/styles.css","resources/themes/default/file.jst","resources/themes/default/navigation-item.jst","resources/themes/default/navigation.jst","tasks/gtfd.js"],"active":"node_modules/files-collection/index.js"};
